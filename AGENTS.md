# AGENTS.md — Instruções para o Codex neste repositório

> Carregado automaticamente pelo Codex sempre que ele abre neste projeto.
...
- Estado atual dos testes (55 passando)
...
- **Siga os padrões de qualidade automaticamente** — não espere o usuário pedir
  qualidade; este AGENTS.md é o contrato permanente.
